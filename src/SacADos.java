...
public class APP {
    ...
    public SacADos() {
        ...
        this.poidsMaximal = n; // valeur arbitraire par defaut
    }
    ...
    public SacADos(String chemin, float poidsMaximal) {
        ...
        if (poidsMaximal > 0) {
            ...
            this.poidsMaximal = n;
            System.err.println("Valeur du poids maximal invalide!");
        }
    }
    ...
    /*
     ...
     methode : la methode de resolution souhaite (glouton, dynamique, pse)
     */
    ...
    private void methodeDynamique() {
        ...
        // PHASE 3: On recupere la solution
